                        ...
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description {{ $percentage < 0 ? 'text-warning' : '' }}">
                                  {{ number_format(abs($percentage), 2) }} % {{ $percentage > 0 ? '▼' : '▲' }} From {{ date('l', strtotime('-1 day')) }}
                                </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description {{ $percentage < 0 ? 'text-warning' : '' }}">
                                  {{ number_format(abs($percentage), 2) }} % {{ $percentage > 0 ? '▼' : '▲' }} From {{ date('F', strtotime('-1 month')) }}
                                </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description {{ $percentage < 0 ? 'text-warning' : '' }}">
                                  {{ number_format(abs($percentage), 2) }} % {{ $percentage > 0 ? '▼' : '▲' }} From {{ date('Y', strtotime('-1 year')) }}
                                </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
